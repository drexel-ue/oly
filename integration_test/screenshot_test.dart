...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RecoveryProvider recoveryProvider = RecoveryProvider(storage);
      final BodyCompProvider bodyCompProvider = BodyCompProvider(storage);
      final NutritionProvider nutritionProvider = NutritionProvider(storage);
      ...
      await tester.pumpWidget(
        buildAppWrapper(WarmupSessionScreen(dayTemplate: day1)),
      );
      await tester.pump(const Duration(milliseconds: 300));
      ...
      await tester.pumpWidget(
        buildAppWrapper(RecoverySessionScreen(routine: routine)),
      );
      await tester.pump(const Duration(milliseconds: 300));
      ...
      await tester.pumpWidget(
        buildAppWrapper(const NutritionDashboardScreen()),
      );
      await takeScrollingScreenshots(
      ...
      await tester.pumpWidget(
        buildAppWrapper(const MetabolicScienceExplainerScreen()),
      );
      await takeScrollingScreenshots(
