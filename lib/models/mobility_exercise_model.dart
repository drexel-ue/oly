  ...
  static List<MobilityExerciseModel> defaultExercises() {
    return <MobilityExerciseModel>[
      ...
      MobilityExerciseModel(
        ...
        category: MobilityCategory.cardioConditioning,
        description:
            'Classic benchmark sprint chipper: 1,000m Row, 50 Thrusters (45 lb / 20.4 kg), 30 Pull-ups. Track splits and PRs.',
        cues: <String>[
          '1,000m Row: Hold steady split 5-8s slower than 2k PR to keep legs primed.',
          '50 Thrusters (45 lb): Full squat below parallel into overhead lockout; break in steady sets.',
          '30 Pull-ups: Dead-hang start, chin clearly over bar; strict, kipping, or banded.',
        ],
        durationSeconds: 600,
        defaultSets: 1,
        defaultReps: 1,
      ...
      MobilityExerciseModel(
        ...
        category: MobilityCategory.cardioConditioning,
        description:
            'The quintessential benchmark sprint: 21-15-9 Barbell Thrusters (95/65 lb) and Pull-ups. Track round splits and PRs.',
        cues: <String>[
          '21-15-9 Thrusters: Full front squat below parallel, direct fluid press overhead into lockout.',
          '21-15-9 Pull-ups: Full dead-hang to chin clearly over bar; kipping, butterfly, or strict.',
          'Target: Sub-3 to 8 minutes; pace the 21s, push through the 15s, sprint the 9s.',
        ],
        durationSeconds: 360,
        defaultSets: 1,
        defaultReps: 1,
      ...
      MobilityExerciseModel(
        ...
        category: MobilityCategory.cardioConditioning,
        description:
            'Classic 3-round benchmark: 400m Run, 21 Kettlebell Swings (53/35 lb), 12 Pull-ups. Track round splits and PRs.',
        cues: <String>[
          '400m Run: Hold steady 85% pace so you can immediately pick up the kettlebell.',
          '21 KB Swings: American overhead lockout with arms straight and bell inverted upward.',
          '12 Pull-ups: Full dead-hang to chin over bar; strict or kipping.',
        ],
        durationSeconds: 720,
        defaultSets: 1,
        defaultReps: 1,
      ...
      MobilityExerciseModel(
        ...
        category: MobilityCategory.cardioConditioning,
        description:
            'Quintessential power sprint: 30 Clean & Jerks for Time (135/95 lb). Quick singles vs touch-and-go pacing.',
        cues: <String>[
          'Floor to Shoulders: Powerful hip extension into rapid clean (power clean recommended for speed).',
          'Shoulders to Overhead: Push jerk or power jerk with full hip, knee, and arm lockout overhead.',
          'Pacing: Quick singles with 2-second resets minimizes lower back exhaustion.',
        ],
        durationSeconds: 300,
        defaultSets: 1,
        defaultReps: 1,
      ...
      MobilityExerciseModel(
        ...
        category: MobilityCategory.cardioConditioning,
        description:
            'Iconic hero benchmark: 5 Rounds of 12 Deadlifts, 9 Hang Power Cleans, 6 Push Jerks (155/105 lb). Barbell cycling and grip grit.',
        cues: <String>[
          'Deadlifts: 11-1 break strategy; rest after 11th rep, then lift rep 12 straight into hang cleans.',
          'Hang Power Cleans: 8-1 break strategy; do 8 reps, rest, clean 9th directly into push jerks.',
          'Push Jerks: Re-dip under the bar and hold onto the barbell through all 6 reps unbroken.',
        ],
        durationSeconds: 600,
        defaultSets: 1,
        defaultReps: 1,
      ...
      MobilityExerciseModel(
        ...
        name: 'CrossFit WOD: Death By Burpees (EMOM)',
        focusArea: MobilityFocusArea.cardio,
        category: MobilityCategory.cardioConditioning,
        description:
            'Ascending minute ladder: 1 burpee in min 1, 2 in min 2, ascending by 1 until failure within the 60s window.',
        cues: <String>[
          'Pacing: Keep cadence relaxed in early rounds (1–8) to conserve your heart rate.',
          'Standards: Chest and thighs must touch the deck; small hop with hands overhead at top.',
          'Mindset: Fight through the 30-second fatigue wall as the reps enter double digits.',
        ],
        durationSeconds: 900,
        defaultSets: 1,
        defaultReps: 1,
      ...
      MobilityExerciseModel(
        ...
        focusArea: MobilityFocusArea.posteriorChain,
        category: MobilityCategory.hypertrophyCore,
        description: 'Glute-Ham Developer (GHD) hyperextensions targeting lumbar erectors, glutes, and hamstrings for posterior chain resilience and lower back decompression.',
        cues: <String>[
          'Set hip pad just below the crease of the hips to allow full lumbar and hip flexion.',
          'Cross arms across chest or hold a weight plate securely against sternum.',
          'Hinge at hips to lower upper body smoothly into a full 90-degree stretch.',
      ...
      MobilityExerciseModel(
        ...
        focusArea: MobilityFocusArea.absCore,
        category: MobilityCategory.hypertrophyCore,
        description: 'Dynamic midline flexion on the Glute-Ham Developer training anterior abdominal wall power, rectus abdominis endurance, and explosive hip flexor drive.',
        cues: <String>[
          'Sit on the GHD pad with pelvis positioned so hips are free to extend.',
          'Secure feet between footpads with ankles locked against the rollers.',
          'Descend backwards under control with slight knee bend until reaching full extension.',
          'Touch the floor or extension pad behind your head with fingertips.',
      ...
      MobilityExerciseModel(
        ...
        focusArea: MobilityFocusArea.quadriceps,
        category: MobilityCategory.hypertrophyCore,
        description: 'Seated machine knee extensions targeting the rectus femoris and vastus medialis (VMO) for knee joint stability, quad hypertrophy, and patellar tendon resilience.',
        cues: <String>[
          'Align knee joints directly with the machine pivot axis and adjust back pad snugly.',
          'Grip handles firmly and brace core to keep hips pinned against the seat.',
