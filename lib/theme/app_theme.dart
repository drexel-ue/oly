...
class AppTheme {
  ...
  static ThemeData get darkTheme {
    return ThemeData.dark().copyWith(
      ...
      textTheme: TextTheme(
        displayLarge: GoogleFonts.outfit(fontSize: 34, fontWeight: FontWeight.bold, color: textPrimary),
        ...
        headlineLarge: GoogleFonts.outfit(fontSize: 22, fontWeight: FontWeight.bold, color: textPrimary),
        headlineMedium: GoogleFonts.outfit(fontSize: 18, fontWeight: FontWeight.bold, color: textPrimary),
        headlineSmall: GoogleFonts.outfit(fontSize: 16, fontWeight: FontWeight.bold, color: textPrimary),
        ...
        labelMedium: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w600, color: textPrimary),
        labelSmall: GoogleFonts.inter(fontSize: 10, fontWeight: FontWeight.w600, color: textSecondary),
      ),
