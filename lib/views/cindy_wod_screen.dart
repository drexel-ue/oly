...
class CindyWodScreen extends StatefulWidget {
  ...
  @override
  State<CindyWodScreen> createState() => _CindyWodScreenState();
}

class _CindyWodScreenState extends State<CindyWodScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      ...
                      child: Icon(
                        _isPreview ? Icons.explore : Icons.timer,
                        color: _isPreview ? AppTheme.secondaryCyan : AppTheme.primaryAmber,
                        size: 28,
                      ),
                    ),
                        ...
                        children: <Widget>[
                          Text(
                            _isPreview
                                ...
                                : 'BENCHMARK CONDITIONING (LIVE LOG)',
                            style: GoogleFonts.outfit(
                              fontSize: 11,
                              fontWeight: FontWeight.bold,
                              color: _isPreview ? AppTheme.secondaryCyan : AppTheme.primaryAmber,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            '5 Pull-ups • 10 Push-ups • 15 Squats\nTrack per-round progressions, scaling & PRs.',
              ...
              // Interactive Cindy WOD Card
              CindyWodCard(
                key: ValueKey('cindy_wod_card_preview_$_isPreview'),
                exercise: cindyExercise,
