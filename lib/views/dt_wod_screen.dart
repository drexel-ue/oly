...
class DtWodScreen extends StatefulWidget {
  ...
  @override
  State<DtWodScreen> createState() => _DtWodScreenState();
}

class _DtWodScreenState extends State<DtWodScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      ...
                      child: Icon(
                        _isPreview ? Icons.explore : Icons.shield_outlined,
                        color: _isPreview ? AppTheme.secondaryCyan : AppTheme.primaryAmber,
                        size: 28,
                      ),
                    ),
                        ...
                        children: <Widget>[
                          Text(
                            _isPreview
                                ...
                                : 'IN HONOR OF USAF SSGT TIMOTHY DAVIS (LIVE)',
                            style: GoogleFonts.outfit(
                              fontSize: 11,
                              fontWeight: FontWeight.bold,
                              color: _isPreview ? AppTheme.secondaryCyan : AppTheme.primaryAmber,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            'Target: 6–10 minutes • Rx: 155 lb (Men) / 105 lb (Women) • Strategic 11-1 breaks.',
              ...
              // Interactive DT WOD Card
              DtWodCard(
                key: ValueKey('dt_wod_card_preview_$_isPreview'),
                exercise: dtExercise,
