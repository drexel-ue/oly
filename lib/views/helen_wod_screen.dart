...
class HelenWodScreen extends StatefulWidget {
  ...
  @override
  State<HelenWodScreen> createState() => _HelenWodScreenState();
}

class _HelenWodScreenState extends State<HelenWodScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
                        ...
                        children: <Widget>[
                          Text(
                            _isPreview
                                ...
                                : '3-ROUND CLASSIC BENCHMARK (LIVE)',
                            style: GoogleFonts.outfit(
                              fontSize: 11,
                              fontWeight: FontWeight.bold,
                              color: _isPreview ? AppTheme.secondaryCyan : AppTheme.primaryAmber,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            'Target: 8–13 minutes • Rx: 53 lb (Men) / 35 lb (Women) • Push the run pace.',
              ...
              // Interactive Helen WOD Card
              HelenWodCard(
                key: ValueKey('helen_wod_card_preview_$_isPreview'),
