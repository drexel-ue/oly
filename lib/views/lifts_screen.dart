...
class _LiftsScreenState extends State<LiftsScreen>
  ...
  void _showUpdateMaxDialog(
    ...
    final LiftSuggestion? suggestion = provider.getSuggestion(lift.id);
  ...
  Widget _buildLiftCard(
    BuildContext context,
    LiftModel lift,
    LiftProvider provider,
    SettingsProvider settings,
  ) {
    final Map<int, double> percentages = provider.getPercentageMatrix(lift.id);
