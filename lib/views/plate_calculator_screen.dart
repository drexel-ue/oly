...
class _PlateCalculatorScreenState extends State<PlateCalculatorScreen> {
  ...
  void _setWeight(double weightKg) {
    setState(() {
      ...
      final double displayVal = settings.toDisplayWeight(_targetWeightKg);
  ...
  Widget build(BuildContext context) {
    ...
    final double displayTarget = settings.toDisplayWeight(_targetWeightKg);
  ...
  List<MapEntry<PlateSpec, int>> _groupPlates(List<PlateSpec> plates) {
    final Map<PlateSpec, int> map = <PlateSpec, int>{};
