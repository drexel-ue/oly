...
def get_oly_curated_catalog() -> List[Dict[str, Any]]:
    ...
    curated = [
        ...
        },
        {
            ...
            'body_part': 'core',
            'target_muscle': 'abs',
            'secondary_muscles': json.dumps(['hip_flexors', 'quadriceps', 'obliques']),
            'equipment': 'other',
            'mechanic': 'compound',
            'force': 'pull',
            'level': 'intermediate',
            'instructions': '1. Position yourself in the Glute-Ham Developer (GHD) machine facing upward with hips off the main pad and feet anchored securely between the footpads.\n2. Descend backwards under control with slight knee bend until reaching full extension and touching the floor or target pad with your fingertips.\n3. Fire your hip flexors, quadriceps, and abdominal wall explosively to reverse the movement.\n4. Accelerate torso upward until fingertips touch the footpad upright or toe anchor.',
            'tips': 'Keep knees slightly bent on the descent; violently snap knees straight on the ascent to fire hip flexors and pull your torso up without straining the lumbar spine.',
            'source': 'oly_curated',
            'source_id': 'ghd_situp',
            'gif_url': None,
            'video_url': 'https://www.youtube.com/results?search_query=GHD+Sit+Up+CrossFit+Movement+Demo',
        },
        {
