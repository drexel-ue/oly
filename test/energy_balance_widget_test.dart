  ...
  group('Energy Balance & Metabolic Science Widget Tests', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpAndSettle();
        expect(
          find.textContaining('Algorithm B: Personalized REE Scaling'),
          findsOneWidget,
        );
        ...
        await tester.pumpAndSettle();
        expect(
          find.textContaining('Workout of the Day (WOD) Caloric Physics'),
          findsOneWidget,
        );
      },
    );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          find.textContaining('COMPENDIUM ACTIVITY PRESETS'),
          findsOneWidget,
        );
