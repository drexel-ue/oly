...
void main() {
  ...
  group('Smart Portion & Scanner Enhancement Tests', () {
    ...
    testWidgets('SmartPortionDrawer renders protein density, macro split bar, and step chips', (tester) async {
      ...
      expect(find.textContaining('10.0g P / 100 kcal'), findsOneWidget); // 20g / 200 kcal = 10.0
      ...
      final currentLog = nutritionProvider.currentDayLog;
    ...
    testWidgets('FoodSearchSheet renders recent scans ribbon when cached products exist', (tester) async {
      await storageService.saveCachedProductJson(testFood.barcode!, testFood.toJson());
