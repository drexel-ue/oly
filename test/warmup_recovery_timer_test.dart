...
void main() {
  ...
  group('Warmup & Recovery Flow Timer & Weight Tests', () {
    testWidgets('Cardio Opener renders Cardio Interval Timer with live session controls', (tester) async {
      tester.view.physicalSize = const Size(1170, 2532);
      tester.view.devicePixelRatio = 2.0;
      addTearDown(() => tester.view.resetPhysicalSize());

      final cardioEx = MobilityExerciseModel(
        id: 'zone2_cardio_row',
        ...
        cues: ['Row or bike at an easy pace.'],
        durationSeconds: 180,
    ...
    testWidgets('Mobility & Foam Roll drills render unified drill timers', (tester) async {
      tester.view.physicalSize = const Size(1170, 2532);
      tester.view.devicePixelRatio = 2.0;
      addTearDown(() => tester.view.resetPhysicalSize());

      final foamEx = MobilityExerciseModel(
        ...
        cues: ['Support your head with hands.'],
        durationSeconds: 90,
        videoUrl: 'https://youtube.com',
      );
    ...
    testWidgets('Accessory exercises render workout-matched sets, weight steppers, and rest toggle', (tester) async {
      tester.view.physicalSize = const Size(1170, 2532);
      tester.view.devicePixelRatio = 2.0;
      addTearDown(() => tester.view.resetPhysicalSize());
